...
ActiveRecord::Schema.define(version: 20141130201402) do
  ...
  create_table "youtube_codes", force: true do |t|
    t.integer  "project_id"
    t.string   "vcode"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "youtube_codes", ["project_id"], name: "index_youtube_codes_on_project_id", using: :btree
